// https://github.com/mui-org/material-ui-docs/blob/latest/packages/material-ui-docs/src/MarkdownElement/MarkdownElement.js
...
export class MarkdownElement extends React.Component<
  IMarkdownElementProps,
  {}
> {
  public render() {
...
export default withStyles(styles as any, { flip: false })(
  MarkdownElement as any
) as any;
