...
export class WorkshopCard extends Component<WorkshopCardProps, {}> {
    ...
    public render() {
        ...
        return (
            <Card className={classes.card}>
                ...
                />
                <CardHeader
                    avatar={<Avatar className={classes.avatar} aria-label="Recipe">R</Avatar>}
                    title="Atelier Sushis, Makis et Témaris"
                    subheader="Samedi 19 Juin 2018, de 14h à 18h"
                />
                <CardContent>
                    <Typography component="p">
                        Découvrez la cuisine japonaise et apprennez des recettes authentiques
                    </Typography>
                </CardContent>
                <CardActions>
