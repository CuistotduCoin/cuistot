...
export class Business extends React.Component<IBusinessProps, {}> {
  public render() {
    ...
    const typeActivity = [
      {
        ...
        image:
          "http://static.cuistotducoin.com/img/business/atelier-afterwork.jpg",
        title: "Atelier Afterwork"
      },
      {
        description: "Atelier de trois heures suivi d'un repas convivial",
        image:
          "http://static.cuistotducoin.com/img/business/atelier-et-repas.jpg",
        title: "Atelier suivi d’un repas"
      },
      {
        description: "Atelier découverte et dégustation",
        image: "http://static.cuistotducoin.com/img/business/degustation.jpg",
        title: "Atelier dégustation"
      },
      {
        description: "Récompensez vos équipes autour d'un repas d'exception !",
        image:
          "http://static.cuistotducoin.com/img/business/repas-prestige.jpg",
      ...
      },
      {
        ...
        image:
          "http://static.cuistotducoin.com/img/business/repas-pratique.jpg",
        title: "Repas pratique"
      },
      {
        description: "Une solution clé en main pour un dejeunez rapide",
        image:
          "http://static.cuistotducoin.com/img/business/repas-ultra-pratique.jpg",
    ...
    const typeWorld = [
      {
        ...
        image:
          "http://static.cuistotducoin.com/img/business/cuisine-du-monde.jpg",
      ...
      },
      {
        ...
        image:
          "http://static.cuistotducoin.com/img/business/cuisine-bien-etre.jpg",
      ...
      },
      {
        ...
        image:
          "http://static.cuistotducoin.com/img/business/cuisine-terroir.jpg",
      ...
      },
      {
        ...
        image:
          "http://static.cuistotducoin.com/img/business/boulangerie-et-patisserie.jpg",
    ...
    const participants = [
      {
        image:
          "http://static.cuistotducoin.com/img/business/participants/arkea.jpg",
        name: "arkea"
      },
      {
        image:
          "http://static.cuistotducoin.com/img/business/participants/brest-metropole.jpg",
        name: "brest metropole et ville"
      },
      {
        image:
          "http://static.cuistotducoin.com/img/business/participants/cadiou.jpg",
        name: "cadiou"
      },
      {
        image:
          "http://static.cuistotducoin.com/img/business/participants/fortuneo.jpg",
        name: "fortuneo"
      },
      {
        image:
          "http://static.cuistotducoin.com/img/business/participants/gl-events.jpg",
        name: "gl events"
      },
      {
        image:
          "http://static.cuistotducoin.com/img/business/participants/hippocampe.jpg",
        name: "hippocampe"
      }
    ];
    return (
          ...
          <Grid item={true} sm={6} xs={12}>
            <Grid container={true} justify="center">
              <img
                ...
                src="http://static.cuistotducoin.com/img/business/organisez.jpg"
              />
            </Grid>
          </Grid>
          <Grid item={true} sm={6} xs={12}>
          ...
          <Grid item={true} sm={6} xs={12}>
            <Grid container={true} justify="center">
              <img
                className={classes.image}
                alt="Atelier Cuistot du Coin"
                src="http://static.cuistotducoin.com/img/business/passez-a-table.jpg"
              />
            </Grid>
          </Grid>
        </Grid>
