...
function encodeFields(fields) {
  ...
  const encoded = Object.keys(fields)
    .filter(key => fields.hasOwnProperty(key) && fields[key])
...
const graphqlify = fields => (
  encodeOperation('query', fields)
);

// Encodes a graphql query
export const encodeQuery = (_nameOrFields, _fieldsOrNil) => (
  encodeOperation('query', _nameOrFields, _fieldsOrNil)
);

// Encodes a graphql mutation
export const encodeMutation = (_nameOrFields, _fieldsOrNil) => (
  encodeOperation('mutation', _nameOrFields, _fieldsOrNil)
);
